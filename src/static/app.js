document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    // Create difficulty badge if difficulty is specified (optional field)
    const difficultyBadge = details.difficulty ? `
      <p class="difficulty-badge"><strong>Difficulty:</strong> ${details.difficulty}</p>
    ` : '';
  ...
  function handleShare(event) {
    ...
    // Create shareable URL (current page URL with activity info)
